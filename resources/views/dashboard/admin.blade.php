...
@section('body')
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-green-500 rounded-lg p-4 shadow-md">
                <div class="flex items-center">
                    <div class="flex-grow">
                        <h3 class="text-white text-2xl font-bold">{{ $totalKatalog }}</h3>
                        <p class="text-white">Katalog</p>
                    </div>
                    <div class="flex-shrink-0">
                        <box-icon name='package' type='solid' size='3rem' color='white'></box-icon>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-red-500 rounded-lg p-4 shadow-md">
                <div class="flex items-center">
                    <div class="flex-grow">
                        <h3 class="text-white text-2xl font-bold">{{ $totalUser }}</h3>
                        <p class="text-white">Admin</p>
                    </div>
                    <div class="flex-shrink-0">
                        <box-icon name='user' type='solid' size='3rem' color='white'></box-icon>
                    </div>
                </div>
            </div>

            <div class="bg-yellow-500 rounded-lg p-4 shadow-md">
                <div class="flex items-center">
                    <div class="flex-grow">
                        <h3 class="text-white text-2xl font-bold">{{ $totalPesanan }}</h3>
                        <p class="text-white">Pesanan</p>
                    </div>
                    <div class="flex-shrink-0">
                        <box-icon name='shopping-bag' type='solid' size='3rem' color='white'></box-icon>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Include Box Icons CDN in your HTML file -->
